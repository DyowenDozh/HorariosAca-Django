...
function renderNavbar() {
    ...
    const navHTML = `
        <nav class="nav-container">
            ...
            <ul class="nav-links">
                <li><a href="/" class="${currentPath === '/' ? 'active' : ''}">${icons.home} <span data-i18n="nav_home">Home</span></a></li>
                <li><a href="/register/" class="${currentPath === '/register/' ? 'active' : ''}">${icons.register} <span data-i18n="nav_register">Register</span></a></li>
                <li><a href="/login/" class="${currentPath === '/login/' ? 'active' : ''}">${icons.login} <span data-i18n="nav_login">Login</span></a></li>
                <li><a href="/tutorials/" class="${currentPath === '/tutorials/' ? 'active' : ''}">${icons.tutorials} <span data-i18n="nav_tutorials">Tutorials</span></a></li>
